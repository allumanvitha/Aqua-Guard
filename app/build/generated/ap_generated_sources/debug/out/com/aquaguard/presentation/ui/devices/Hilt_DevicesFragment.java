...
abstract class Hilt_DevicesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DevicesFragment() {
    super();
  }

  Hilt_DevicesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DevicesFragment_GeneratedInjector) this.generatedComponent()).injectDevicesFragment(UnsafeCasts.<DevicesFragment>unsafeCast(this));
    }
  }
