...
abstract class Hilt_AIAssistantFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AIAssistantFragment() {
    super();
  }

  Hilt_AIAssistantFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AIAssistantFragment_GeneratedInjector) this.generatedComponent()).injectAIAssistantFragment(UnsafeCasts.<AIAssistantFragment>unsafeCast(this));
    }
  }
